	        ...
	        <div class="panel-body">
	            <div class="table-responsive">
	                <form action='{{$DB_table->id}}' method="post" enctype="multipart/form-data" id='form_Insert'>	                
		                		...
		                		<div class="flex_col">
			                		<div class="group__item">
			                			...
			                			<div class='group_input'>
											...
											<input type="text"  class="group_input__item" id="i_tel" name="tel" placeholder="Tel" value='{{$DB_table->tel}}'/>
											<p class="group_input__help"></p>
					                	</div>
					                	<div class="group_input">
					                		<label class="group_input__title" for="">Date of birth</label>
											<input type="date" class="group_input__item" id="i_date_of_birth" name="date_of_birth" placeholder="date" value="{{$DB_table->date_of_birth}}">
											<p class="group_input__help"></p>
					                	</div>
					                	<div class='group_input'>
		                		...
		                		<div class="flex_col">
		                			<div class="group__item">
					                	...
					                	<div class='group_input clearfix'>
						                	...
						                	@else 
												<input type="radio" id='gender_true' class="group_input__item" name="gender" value="1"/>
						                		<label for="gender_true">Male</label>
												<input type="radio" id='gender_false' class="group_input__item" checked="checked" name="gender" value="0"/>
						                		<label for="gender_false">Female</label>
					                		@endif											
					                		<p class="group_input__help"></p>
					                	</div>
	                	...
	                	<p class="group_input__submit"><a href="{{route('NRGCAddresses_getDetail',['id'=>$DB_table->id])}}">Addresses Area</a></p>
