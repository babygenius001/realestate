		...
		<div class="panel panel-default">
	        ...
	        <div class="panel-body">
	            <div class="table-responsive">
	                <form action="{{route('NRPCAddresses_postInsert')}}" method="post" enctype="multipart/form-data" id='form_Insert'>	                	
		                	...
		                	<div class='form_group--inner clearfix'>
		                		<div class="flex_col">
			                		<div class="group__item">
			                			<div class='group_input'>
											...
											<input type="text"  class="group_input__item" id="i_address" name="" placeholder="" disabled="disabled" value="{{$DB_table->name}}"/>
											<p class="group_input__help"></p>
					                	</div>
			                			<div class='group_input'>
					                		<label class="group_input__title required" for="">Address:</label>
											<input type="text"  class="group_input__item" id="i_address" name="address" placeholder="Address"/>
											<p class="group_input__help"></p>
					                	</div>
			                		</div>	                			
		                		</div>
		                		<div class="flex_col">
		                			<div class="group__item">
			                			...
			                			<div class='group_input'>
											<input type="text"  class="group_input__item visible" id="i_customers_id" name="customers_id" value='{{$DB_table->id}}'/>
											<p class="group_input__help"></p>
					                	</div>
									</div>
		                		</div>
	                	...
	                	<p class="group_input__submit"><a href="{{route('NRGCCustomers_getDetail',['id'=>$DB_table->id])}}">Back</a></p>
	                </form>
	            </div>
	        </div>
