		                	...
		                	<div class='form_group--inner clearfix'>
		                		<div class="flex_col">
			                		<div class="group__item">
					                	...
					                	<div class='group_input'>
					                		<label class="group_input__title" for="">Categories name:</label>
											<select name="products_categories_id" class="group_input__select" id="i_products_categories_id">
												@foreach($craw_products_categories as $categories_item)
													@if($categories_item->id != $DB_table->products_categories_id)
														<option value="{{$categories_item->id}}">{{$categories_item->name}}</option>
													@else
														<option selected='selected' value="{{$categories_item->id}}">{{$categories_item->name}}</option>
