		                		...
		                		<div class="flex_col">
			                		<div class="group__item">
					                	...
					                	<div class='group_input'>
											...
											<input type="text"  class="group_input__item" id="i_abbreviation" name="abbreviation" placeholder="E.g. LG, Sony, etc,.." value="{{$DB_table->abbreviation}}" />
											<p class="group_input__help"></p>
					                	</div>
					                	<div class='group_input'>
					                		<label class="group_input__title" for="">Abbreviation:</label>
					                	...
					                	<div class='group_input'>
											...
											<input type="text"  class="group_input__item" id="i_url" name="url" placeholder="E.g. http://realestate.com.vn" value="{{$DB_table->url}}" />
											<p class="group_input__help"></p>
					                	</div>
			                		</div>	
			                		<div class="group__item">
		                		...
		                		<div class="flex_col">
		                			<div class="group__item">
					                	...
					                	<div class='group_input'>
											...
											<input type="text"  class="group_input__item" id="i_keyword" name="keyword" placeholder="Smart phone, Teddy, Etc,.." value="{{$DB_table->keyword}}" />
											<p class="group_input__help"></p>
					                	</div>
