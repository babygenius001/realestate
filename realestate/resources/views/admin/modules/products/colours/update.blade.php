		                		...
		                		<div class="flex_col">
			                		...
			                		<div class="group__item">
			                			<div class='group_input'>
											...
											<input type="color"  class="group_input__item" id="i_getColour" name="getColour" value='{{$DB_table->hex_colour}}'/>
											<p class="group_input__help"></p>
					                	</div>
			                			<div class='group_input'>
					                		<label class="group_input__title required" for="">colour:</label>
											<input type="text" class="group_input__item" id="i_hex_colour" name="hex_colour" placeholder="{{$DB_table->hex_colour}}" value='{{$DB_table->hex_colour}}'/>
											<p class="group_input__help"></p>
					                	</div>
			                		</div>
		                		</div>
