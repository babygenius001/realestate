	                    ...
	                    <tbody>
	                    	...
	                    	@foreach($DB_table as $items)                   	
		                        ...
		                        <tr>
		                            ...
		                            <td>
										<a href="{{route('NRGCTypes_getDetail',['id' => $items->products_types_id])}}" target='__blank'>{{$items->m_products_types->name}}</a>

		                            </td>
		                            <td>
										<a href="{{route('NRGCBrands_getDetail',['id' => $items->products_brands_id])}}" target='__blank'>{{$items->m_products_brands->name}}</a>
		                            </td>	
		                            <td class="box-img"><img src="{{asset($items->image)}}" alt="{{$items->name}}"/></td>	
		                            <td class="box-center">{{$items->is_new}}</td>	
		                            <td class="box-center">{{$items->is_hot}}</td>	
