		...
		<div class="panel panel-default">
	        ...
	        <div class="panel-body">
	            <div class="table-responsive">
	                <form action="{{route('NRPCBrands_postInsert')}}" method="post" enctype="multipart/form-data" id='form_Insert'>	                	
		                		...
		                		<div class="flex_col">
			                		<div class="group__item">
					                	...
					                	<div class='group_input'>
											...
											<input type="text"  class="group_input__item" id="i_abbreviation" name="abbreviation" placeholder="E.g. LG, Sony, etc,.."/>
											<p class="group_input__help"></p>
					                	</div>
			                		</div>	
			                		<div class="group__item">
		                		...
		                		<div class="flex_col">
		                			<div class="group__item">
					                	...
					                	<div class='group_input'>
											...
											<input type="text"  class="group_input__item" id="i_keyword" name="keyword" placeholder="Smart phone, Teddy, Etc,.."/>
											<p class="group_input__help"></p>
					                	</div>
