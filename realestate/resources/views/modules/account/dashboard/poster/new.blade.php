				...
				<div class="flex_col">
            		...
            		<div class="group__item">
            			<div class='group_input'>
							...
							<select class="group_input__select" id="i_products_id" name='products_id'>
								@foreach($craw_products as $products_item)
									<option value="{{$products_item->id}}">{{$products_item->name}}</option>
					    		@endforeach
							</select>
